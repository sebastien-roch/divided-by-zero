...
The goal is to add a slight shadow at the top of the scrolled container, but only when the container has been scrolled
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwMzc5MTAzODhdfQ==
-->